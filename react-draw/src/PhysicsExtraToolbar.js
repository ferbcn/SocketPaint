...
import './PhysicsExtraToolbar.css';

function PhysicsExtraToolbar({ gravity, elasticity, setGravity, setElasticity, timeOut, setTimeOut }) {
...
export default PhysicsExtraToolbar;